...
def main(i, data, model):
    ...
    extractor = " Your final answer should be put between two ##, like ## ABC ## (if your final answer is ABC), at the end of your response."

    question = "Context: " + context + "Question: " + question + " Explain your reasoning step-by-step." + extractor
    ...
    QAs['answer'] = answer
    QAs['P1_ans'] = normalize_answer(answer) in get_answer_from_text(response_1)
    QAs['P2_ans'] = normalize_answer(answer) in get_answer_from_text(response_2)
    QAs['P3_ans'] = normalize_answer(answer) in get_answer_from_text(response_3)
...
if __name__=='__main__':
    ...
    path_output = f'{output_dir}/{dataset}_{model}_baseline.jsonl'
    ...
    if flag==2 or flag==3:
        ...
        for i in range(length): 
            if data_est[i]['P1_ans']==True:
                count_1 += 1
            if data_est[i]['P3_ans']==True:
                count_2 += 1
